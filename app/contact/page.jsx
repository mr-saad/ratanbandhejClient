      ...
      <section className="overflow-hidden rounded-md border border-stone-100 shadow-xl shadow-black/5 dark:border-white/10">
        <div className="grid md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between bg-stone-900 p-5 md:p-10">
            <h5 className="mb-2 font-medium tracking-widest uppercase">
              Get in touch
            </h5>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="mb-1 font-medium text-white">Email Us</h4>
                  <a
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="mb-1 font-medium text-white">Call Us</h4>
                  <a
                    href="tel:9228405162"
                    className="transition hover:text-white"
                  >
          ...
          <form className="grid gap-10 p-5 md:p-10">
