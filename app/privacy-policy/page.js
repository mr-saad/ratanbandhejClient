  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <ul className="list-disc ml-4">
        <li>
          <p>
            <strong className="highlight">Account</strong> means a unique
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Ratan Bandhej, 1079,
        ...
        <li>
          <p>
            <strong className="highlight">Device</strong> means any device that
        ...
        <li>
          <p>
            <strong className="highlight">Personal Data</strong> is any
        ...
        <li>
          <p>
            <strong className="highlight">Service</strong> refers to the
            Website.
          </p>
        </li>
        <li>
          <p>
            <strong className="highlight">Service Provider</strong> means any
        ...
        <li>
          <p>
            <strong className="highlight">Usage Data</strong> refers to data
        ...
        <li>
          <p>
            <strong className="highlight">Website</strong> refers to Ratan
            Bandhej, accessible from{" "}
            <a
        ...
        <li>
          <p>
            <strong className="highlight">You</strong> means the individual
      ...
      <ul className="list-disc ml-4">
        ...
        <li>
          <p>
            <strong className="highlight">To manage Your Account:</strong> to
        ...
        <li>
          <p>
            <strong className="highlight">To provide You</strong> with news,
        ...
        <li>
          <p>
            <strong className="highlight">To manage Your requests:</strong> To
