  ...
  return (
    <div className="Container">
      <Link
        ...
        className={`mb-2 inline-block rounded-[200px] border border-current bg-transparent px-4 py-2 font-bold text-red-800 [corner-shape:squircle] md:hidden dark:text-white ${searchCat ? "bg-linear-to-45 from-red-800 to-red-600 text-white!" : ""}`}
      >
        <svg
