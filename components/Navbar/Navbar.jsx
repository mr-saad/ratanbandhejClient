...
export default function Navbar() {
  return (
    <nav
      className={`nav fixed inset-x-2 top-2 z-12 grid grid-cols-[1fr_2fr_1fr] items-center justify-between rounded-xl bg-stone-100/75 px-5 py-3 shadow-lg backdrop-blur-lg select-none md:text-base`}
    >
      <MenuToggler />
      <Link
        prefetch
